                            ...
                            <div class="card-body">
                                <form action="users?action=edit" method="post">
                                    <div class="form-group center">
                                        ...
                                        <br>
                                        <%--     neu hien tai tai khoan dang hoat dong--%>
                                        <label>Status</label><br>
                                        <c:if test="${user.activate == true}">
                                            <input type="radio" id="activate" name="activate" value="activate" checked>
                                            <lable for="activate">Activate</lable>
                                            <input type="radio" id="no activate" name="activate" value="no activate">
                                            <lable for="no activate">Not Activate</lable>
                                            <br>
                                        </c:if>

                                        <%--     neu hien tai tai khoan dang bi khoa--%>
                                        <c:if test="${user.activate == false}">
                                            <input type="radio" id="activate" name="activate" value="activate">
                                            <lable for="activate">Activate</lable>
                                            <input type="radio" id="no activate" name="activate" value="no activate"
                                                   checked>
                                            <lable for="no activate">Not Activate</lable>
