    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Manager Category</h1>
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">[CategoriesPage]</li>
                        </ol>
                    </div>
                    <!-- /.col -->
                </div>
                            ...
                            <div class="card-body">
                                ...
                                >
                                    ...
                                    <tr>
                                        ...
                                        <%--                                        <th>Exist</th>--%>
                                        <th class="col-1 text-center">List product</th>
                                    ...
                                    <c:forEach items="${categories}" var="category">
                                        <c:if test="${category.exist==true}">
                                            <tr>
                                                <td class="text-center"><c:out value="${category.id_category}"/></td>
                                                <td><c:out value="${category.name_category}"/></td>
                                                <td class="text-center">
                                                    <a href="products?action=products&id=${category.id_category}">
                                                        <i class="fas fa-list"></i>
                                                    </a>
                                                </td>
                                                <td class="text-center">
                                                    <a href="/categories?action=edit&id=${category.id_category}">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                </td>
                                                <td class="text-center">
                                                    <a href="/categories?action=delete&id=${category.id_category}">
