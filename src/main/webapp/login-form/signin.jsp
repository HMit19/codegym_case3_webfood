    ...
    <div class="container-login100">
        <div class="wrap-login100">
            <div class="login100-pic js-tilt" data-tilt>
                <img src="login-form/images/img-01.png" alt="IMG" style="margin-top: 14%; margin-left: 12%;">
            </div>

            <form action="login-signup" class="login100-form validate-form" method="post" id="Login-Form">
                ...
                <div class="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
                    <input class="input100" type="text" name="_email" placeholder="Email" id="email">
                ...
                <div class="text-center p-t-130">
                    <a class="txt2" href="login-signup?action=signup">
                        Create your Account
...
<!--them thu vien su dung swal js thong bao neu login thanh cong-->
<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
<script type="text/javascript">
    const status = document.getElementById("status").value;
    if (status === "false") {
        swal("Login Failed!", "Please check your email or password!", "error");
    }
</script>
</body>
</html>